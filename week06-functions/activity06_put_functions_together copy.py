# This program adds together the functions created in activity02* through activity05*. This program keeps displaying the menu until the user picks q. if the user chooses a then call a function called do_add(), if the user chooses v then call a function called do_view(). do_view is not yet fully defined. 
